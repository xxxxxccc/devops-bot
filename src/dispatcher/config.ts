...
export function getDispatcherMemoryConfig(): DispatcherMemoryConfig {
  return {
    ...
    recentChatCount: parseIntEnv('DISPATCHER_RECENT_CHAT_COUNT', 10, 0),
    includeMemoryIndex: parseIndexMode(process.env.DISPATCHER_MEMORY_INDEX_MODE),
    maxPromptChars: parseIntEnv('DISPATCHER_MAX_PROMPT_CHARS', 16000, 2000),
    ...
    recentChatBudgetChars: parseIntEnv('DISPATCHER_RECENT_CHAT_BUDGET_CHARS', 3500, 0),
